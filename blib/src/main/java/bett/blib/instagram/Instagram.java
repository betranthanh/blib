package bett.blib.instagram;

import android.content.Context;
import android.os.AsyncTask;

import bett.blib.dialog.LoadingDialog;
import bett.blib.instagram.util.Cons;
...
////			progressDlg.setMessage("Processing. Please wait...");
...
//			lp.copyFrom(progressDlg.getWindow().getAttributes());
//			lp.width = 150;
//			lp.height = 150;
//			progressDlg.getWindow().setAttributes(lp);
